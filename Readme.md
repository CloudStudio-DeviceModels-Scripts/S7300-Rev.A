...
# Parsing + Configuration Script – S7 300 - Rev. A

This **Parsing + Configuration** script is designed for the **S7 300** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – S7 300 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **S7 300** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
